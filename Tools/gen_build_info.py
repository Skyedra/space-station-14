...
FORK_ID = "blepstation"
BUILD_URL = f"https://cdn.blepstation.com/blep-builds/{{FORK_VERSION}}/{FILE}"
MANIFEST_URL = f"https://blepstation.com/robust-content/version/{{FORK_VERSION}}/manifest"
MANIFEST_DOWNLOAD_URL = f"https://blepstation.com/robust-content/version/{{FORK_VERSION}}/download"
